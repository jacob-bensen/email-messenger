 ...
 * {@code signatureHtml} is the correspondent's most recent signature, lifted
 * out of the bubbles so the chat can pin it once beside the timeline rather
 * than repeating it under every message; "" when none was detected.
 */
