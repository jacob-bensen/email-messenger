...
class TrialConversionNudgeServiceTest {
    ...
    @Test
    void returnsPersonalNudgeWhenTrialEndsInThreeDays() {
        Subscription sub = new Subscription(user, "cus_1", "trialing");
        sub.setPlan(Plan.PERSONAL);
    ...
    @Test
    void returnsTeamNudgeWhenTrialEndsInOneDay() {
        Subscription sub = new Subscription(user, "cus_1", "trialing");
    ...
    void dismissKeyChangesAsTrialApproachesExpiry() {
        ...
        threeDay.setPlan(Plan.PERSONAL);
    ...
    @Test
    void returnsEmptyWhenPlanIsEnterprise() {
        Subscription sub = new Subscription(user, "cus_1", "trialing");
        sub.setPlan(Plan.ENTERPRISE);
